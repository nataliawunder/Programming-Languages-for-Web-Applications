...
<html lang="en" data-bs-theme="dark">
    ...
    <body data-new-gr-c-s-check-loaded="14.1093.0" data-gr-ext-installed="">
        ...
        <nav class="navbar navbar-expand-md">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" href="?command=homeLoggedIn">Home</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container mt-3 text-center">
            ...
            <a class="btn" href="?command=play">PLAY</a>
            <hr>
        </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <p>In Pokéfusion, the goal of the game is for players to creatively fuse two Pokémon into a single 
                                ...
                                rate the fusion. Players can browse the gallery, leave ratings, and draw inspiration from the community's most popular fusions.
                                Draw a fusion and share them with your friends by clicking the button below!</p>
                            <a href="?command=play" class="btn btn-sm">Play</a>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
        ...
        <div class="container">
            <footer class="py-3 my-4">
                <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                    ...
                    <li class="nav-item"><a class="nav-link px-2 text-muted" href="?command=logout">Log Out</a></li>
                </ul>
