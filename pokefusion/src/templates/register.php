...
<html lang="en" data-bs-theme="dark">
    <head>
        <!-- https://getbootstrap.com/docs/5.0/utilities/display/ 
            used for hiding html and re-displaying it bootstrap classes
            https://www.w3schools.com/jsref/met_document_addeventlistener.asp
            event listeners help
            https://www.w3schools.com/jsref/jsref_regexp_test.asp
            regex function client side validation
        -->
        <!--
            Contributions: 
        ...
        <meta name="description" content="Register Screen for Pokéfusion">
        ...
        <title>Register for Pokéfusion?</title>
