...
<html lang="en" data-bs-theme="dark">
    <head>
        <!-- https://getbootstrap.com/docs/5.0/components/modal/
            for the creation of modals in bootstrap for a pop up
            https://stackoverflow.com/questions/34612500/what-does-the-code-body-onhidden-bs-modal-modal-function-d
            for using hidden.bs.modal
        -->
        ...
        <meta name="description" content="Login screen for Pokéfusion">
        ...
        <title>Login to Pokéfusion</title>
